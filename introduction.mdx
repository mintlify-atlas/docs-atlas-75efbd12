...
[Backtesting.py](https://kernc.github.io/backtesting.py/doc/backtesting/) is a fast, lightweight Python framework for testing trading strategies against historical market data. It gives you a clean, minimal API to define a strategy, run a simulation, inspect detailed statistics, and explore interactive charts — all without locking you into a particular data provider or indicator library.
